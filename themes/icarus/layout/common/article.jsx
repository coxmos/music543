...
module.exports = class extends Component {
    render() {
        ...
        const image = page.image ? url_for(page.image) : null;
        const aplayer = `<link rel="stylesheet" class="aplayer-secondary-style-marker" href="/assets/css/APlayer.min.css"><script src="/assets/js/APlayer.min.js" class="aplayer-secondary-script-marker"></script>\
        <div id="aplayer-${page.date.format('YYYYMMDD')}" class="aplayer aplayer-tag-marker" style="margin-bottom: 20px;">\
            <pre class="aplayer-lrc-content"></pre>\
        </div>\
        <script>\
          var ap = new APlayer({\
            element: document.getElementById("aplayer-${page.date.format('YYYYMMDD')}"),\
            narrow: false,\
            autoplay: false,\
            showlrc: false,\
            music: {\
        ...
        const finalContent = page.media ? aplayer + page.content : page.content;
            ...
            <div class="card">
                ...
                {image ? <div class="card-image">
                    {index ? <a href={url_for(page.link || page.path)} class="image is-7by3">
                        <img class="fill" src={image} alt={page.title || image} />
                ...
                <article class={`card-content article${'direction' in page ? ' ' + page.direction : ''}`} role="article">
                    ...
                    {/* Content/Excerpt */}
                    <div class="content" dangerouslySetInnerHTML={{ __html: index && page.excerpt ? page.excerpt : finalContent }}></div>
                    {/* Licensing block */}
